...
class nft(db.Model):
    ...
    def __init__(self, mint, standard, name, symbol, metaplex_metadataUrl, metaplex_updateAuthority,
                 metaplex_sellerFeeBasisPoints, metaplex_primarySaleHappened, metaplex_isMutable,
                 metaplex_masterEdition, metaplex_owners_address, metaplex_owners_verified, metaplex_owners_share):
        self.mint = mint
